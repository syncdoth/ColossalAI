...
sudo -E env "PATH=$PATH" colossalai run --nproc_per_node 8 --hostfile $HOSTFILE pretrain.py \
    --config ../../../retnet/configs/retnet-7b \
    --model_name retnet_hf \
    ...
    --run_name retnet-7b-glu-tok-llama-3d-parallel-test \
