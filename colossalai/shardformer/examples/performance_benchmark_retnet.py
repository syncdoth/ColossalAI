...
model_func = lambda: RetNetForSequenceClassification(MODEL_CONFIG)
...
configs = [
    triton.testing.Benchmark(
        ...
        styles=[("red", "-"), ("blue", "-")],
        ylabel="ms",
        plot_name=f"retnet_for_sequence_classification-batch-{BATCH}",
...
# torchrun --standalone --nproc_per_node=2 performance_benchmark_retnet.py
